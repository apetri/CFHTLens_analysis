...
FTmapGen_Gaus = lambda r: pickle.load(open(CMBlensing_dir+'kappaOutput_gaus/kappaMap%03dTT_3.pkl'%(r)))
...
def compute_GRF_PDF_ps_pk (r, IFT=0, Gaus=0):
	if IFT:
...
save(CMBlensing_dir+'plot/noisy_z1100_stats77_kappa.npy', all_stats77)
#all_stats77 = load (CMBlensing_dir+'plot/all_stats77_TT.npy')
#ps_all77 = all_stats77[:,:bins]
#PDF_all77 = all_stats77[:, bins:bins+len(PDFbins)-1]
#peaks_all77 = all_stats77[:, bins+len(PDFbins)-1:]

### noisy GRF
all_stats77_GRF = array([compute_GRF_PDF_ps_pk(r, IFT=1, Gaus=1) for r in range(1024)])
save(CMBlensing_dir+'plot/noisy_z1100_stats77_GRF.npy', all_stats77_GRF)
#all_stats77_GRF = load(CMBlensing_dir+'plot/all_stats77_GRF.npy')
