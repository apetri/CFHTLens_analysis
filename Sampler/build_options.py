...
dimensionality=[
("dimensionality","dimensions",int,3),
("dimensionality","number_of_points",int,10),
("dimensionality","p",float,2.0),
("dimensionality","lambda",float,1.0)
]
...
io=[
("input/output","save_cost",int,1),
("input/output","cost_file[128]",str,"cost.txt"),
("input/output","points_file[128]",str,"points.txt"),
("input/output","save_initial_step",int,0),
("input/output","diagonal_file[128]",str,"points_diagonal.txt"),
("input/output","first_shuffle_file[128]",str,"first_shuffle.txt")
]

scalar_options=[
("Geometrical quantities of the problem",dimensionality),
("Random seeds",random),
("Input/output paths",io)
]
