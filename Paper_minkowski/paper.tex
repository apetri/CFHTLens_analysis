...
%ZH: Important: we never describe that we have R=1000 realization of
%    each model, by random rotations and shifts of the single N-body run.
%    This should be added above, where the simulations and the ray-tracing is discussed.
...
%ZH: you wrote ``bin'' here, but I changed it to matrix element. All NxN_bin entries are whitened, presumably.
...
%ZH: we should cite the dark energy survey (DES), and Subaru, and maybe also WFIRST and LSST here.
