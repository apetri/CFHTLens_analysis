...
% "features" or "descriptors" are used interchangeably throughout the paper. It may be sufficient to state this here, but it might be clearer to use only "descriptors" Morgan 2/16/2015
