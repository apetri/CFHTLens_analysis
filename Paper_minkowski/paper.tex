...
$(\Omega_m,\sigma_8)$ & PS,$V_0,V_1,V_2$,LM & $1^\prime$ & BAD mask & Stability of contours & Figure \ref{robustnessfig} \\ \hline 
$(\Omega_m,\sigma_8)$ & PS(3),$V_0(5),V_1(20),V_2(20)$,LM(9) & $1^\prime$ & BAD mask &\pbox{20cm}{$1\sigma$ constraints from CFHTLenS \\ and mock observations}  & Figures \ref{contours3single},\ref{contours3single}b \\ \hline
$(w,\Sigma_8)$ & PS(3),$V_0(10),V_1(10),V_2(10)$,LM(9) & $1^\prime$ & BAD mask & contours from CFHTLenS & Figure \ref{contours3singleRep} \\ \hline 
$\Sigma_8$ & PS(3),$V_0(10),V_1(10),V_2(10)$,LM(9) & $1^\prime$ & BAD mask & $\mathcal{L}(\Sigma_8)$ from CFHTLenS & Figure \ref{likelihoodSi8single} \\ \hline
$(\Omega_m,\sigma_8)$ & PS(3)$\times V_0(5)\times V_1(20)\times V_2(20)\times$LM(9) & $1^\prime$ & BAD mask & \pbox{20cm}{constraints from CFHTLenS \\ combining statistics} & Figure \ref{contours3combined} \\ \hline
$(w,\Sigma_8)$ & PS(3)$\times V_0(10)\times V_1(10)\times V_2(10)\times$LM(9) & $1^\prime$ & BAD mask & \pbox{20cm}{constraints from CFHTLenS \\ combining statistics} & Figure \ref{contours3combined}b \\ \hline 
$\Sigma_8$ & PS(3)$\times V_0(10)\times V_1(10)\times V_2(10)\times$LM(9) & $1^\prime$ & BAD mask & \pbox{20cm}{$\mathcal{L}(\Sigma_8)$ from CFHTLenS \\ combining statistics} & Figure \ref{likelihoodSi8cross} \\ \hline
\end{tabular}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.5]{Figures/contoursSigma8Om055_cross.eps}
\end{center}
